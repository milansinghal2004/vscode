...
int main() {
    while (true) {
        // Test-and-set the flag variable to indicate that the parent wants to enter the critical section
        ...
        // Clear the flag variable to indicate that the critical section is available
        flag = 0;
    }
